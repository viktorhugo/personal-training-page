...
export default function Navbar2() {
    ...
    return (
        ...
        <nav className="fixed top-0 w-full z-50">
            <div className="absolute inset-0 bg-black/90 backdrop-blur-2xl border-b border-gray-800/50 shadow-lg shadow-black/40"></div>
            ...
            <div className="hidden lg:flex items-center space-x-1 xl:space-x-2">
                ...
                <div className="ml-4 xl:ml-8">
                    <button className="relative px-4 xl:px-8 py-3 xl:py-4 bg-gradient-to-r from-orange-500 via-orange-600 to-red-600 text-white font-bold rounded-xl xl:rounded-2xl text-xs xl:text-sm overflow-hidden group transform hover:scale-105 transition-all duration-300 shadow-xl shadow-orange-500/25">
            ...
            <div className="bg-black/95 backdrop-blur-2xl border-b border-gray-800/50 shadow-2xl shadow-black/40">
                ...
                <div className="flex flex-col space-y-1 sm:space-y-2">
                    ...
                    <div className={`pt-4 sm:pt-6 ${isMobileMenuOpen ? "animate-fade-in-up delay-300" : ""}`}>
                        <button
                            className="w-full relative px-6 sm:px-8 py-4 sm:py-5 bg-gradient-to-r from-orange-500 via-orange-600 to-red-600 text-white font-bold rounded-xl sm:rounded-2xl text-sm sm:text-base overflow-hidden group shadow-xl shadow-orange-500/25"
                            onClick={closeMobileMenu}
                        >
